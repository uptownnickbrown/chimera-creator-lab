...
SYSTEM_PROMPT = (
    ...
    "visual_spec must never mention a franchise, brand, or a named character "
    "from games, cartoons, or movies (no 'like a Night Fury', no "
    "'Charizard-style') — the image model rejects those outright; describe "
    "the anatomy in plain words instead. "
